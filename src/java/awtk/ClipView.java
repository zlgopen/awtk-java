 ...
 *
 */
public class ClipView extends Widget {
 public long nativeObj;

 public ClipView(long nativeObj) {
   super(nativeObj);
 }

 static public ClipView cast(long nativeObj) {
   return new ClipView(nativeObj);
 }
 ...
 */
 public  static Widget create(Widget parent, int x, int y, int w, int h)  {
   return new ClipView(clip_view_create(parent != null ? (parent.nativeObj) : 0, x, y, w, h));
 }
 ...
 * @returns clip_view对象。
 */
 public  static ClipView cast(Widget widget)  {
   return new ClipView(clip_view_cast(widget != null ? (widget.nativeObj) : 0));
 }
