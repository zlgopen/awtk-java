 ...
 *
 */
public class TButtonGroup extends TWidget { 
 ...
 * @return 对应的Java对象。
 */
 public TButtonGroup(long nativeObj) {
   super(nativeObj);
 }
 ...
 * @return 对应的Java对象。
 */
 static public TButtonGroup cast(long nativeObj) {
   return new TButtonGroup(nativeObj);
 }
